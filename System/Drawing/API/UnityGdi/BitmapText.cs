...
namespace System.Drawing
{
    public class BitmapText : Image
    {
        ...
        public override void Apply()
        {
            ...
            uTexture = Graphics.GAPI.CreateTexture(tSize.Width, tSize.Height);
            ...
            for (int i = 0; i < Text.Length; i++)
            {
                ...
                if (cW > 0 && cH > 0)
                {
                    ...
                    var charTexture = Graphics.GAPI.CreateTexture(textC.Texture.Width, textC.Texture.Height);
                    ...
                    {
                        Debug.LogWarning("scaling not working");
