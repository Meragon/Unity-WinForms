...
namespace System.Windows.Forms
{
    public class TabControl_Old : Control
    {
        ...
        public class TabPageCollection : IEnumerator<TabPage>, IEnumerable
        {
            ...
            private TabControl_Old _owner;

            private int _currentIndex = -1;
            public int CurrentIndex { get { return _currentIndex; } }
            public int HeaderLeftOffset { get; set; }

            public TabPageCollection(TabControl_Old owner)
            {
        ...
        public class TabPage
        {
            ...
            private TabControl_Old.TabPageCollection _owner;
            ...
            public TabPage(TabControl_Old.TabPageCollection owner, string text)
            {
                _IdPool++;
                _id = _IdPool;
                _owner = owner;
            ...
            public TabPage(TabControl_Old.TabPageCollection owner, string text, Control[] objects)
            {
                _IdPool++;
                _id = _IdPool;
                _owner = owner;
